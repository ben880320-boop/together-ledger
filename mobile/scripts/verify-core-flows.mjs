...
const checks = [
  ...
  ["Android 交付版本為 v1.3.16／versionCode 39", appConfig.includes('"version": "1.3.16"') && appConfig.includes('"versionCode": 39') && mobilePackage.includes('"version": "1.3.16"') && app.includes('const APP_VERSION = "1.3.16"')],
