...
const checks = [
  ...
  ["Android 交付版本為 v1.3.8／versionCode 31", appConfig.includes('"version": "1.3.8"') && appConfig.includes('"versionCode": 31') && mobilePackage.includes('"version": "1.3.8"') && app.includes('const APP_VERSION = "1.3.8"')],
