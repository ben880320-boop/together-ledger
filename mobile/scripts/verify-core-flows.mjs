...
const checks = [
  ...
  ["Android 交付版本為 v1.3.13／versionCode 36", appConfig.includes('"version": "1.3.13"') && appConfig.includes('"versionCode": 36') && mobilePackage.includes('"version": "1.3.13"') && app.includes('const APP_VERSION = "1.3.13"')],
