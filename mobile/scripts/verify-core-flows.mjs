...
const checks = [
  ...
  ["Android 交付版本為 v1.3.7／versionCode 30", appConfig.includes('"version": "1.3.7"') && appConfig.includes('"versionCode": 30') && mobilePackage.includes('"version": "1.3.7"') && app.includes('const APP_VERSION = "1.3.7"')],
