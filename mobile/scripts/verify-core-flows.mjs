...
const checks = [
  ...
  ["Android 交付版本為 v1.3.5／versionCode 28", appConfig.includes('"version": "1.3.5"') && appConfig.includes('"versionCode": 28') && mobilePackage.includes('"version": "1.3.5"') && app.includes('const APP_VERSION = "1.3.5"')],
