...
const checks = [
  ...
  ["Android 交付版本為 v1.3.15／versionCode 38", appConfig.includes('"version": "1.3.15"') && appConfig.includes('"versionCode": 38') && mobilePackage.includes('"version": "1.3.15"') && app.includes('const APP_VERSION = "1.3.15"')],
