...
const checks = [
  ...
  ["Android 交付版本為 v1.3.17／versionCode 40", appConfig.includes('"version": "1.3.17"') && appConfig.includes('"versionCode": 40') && mobilePackage.includes('"version": "1.3.17"') && app.includes('const APP_VERSION = "1.3.17"')],
