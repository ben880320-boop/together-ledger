...
const checks = [
  ...
  ["Android 交付版本為 v1.3.14／versionCode 37", appConfig.includes('"version": "1.3.14"') && appConfig.includes('"versionCode": 37') && mobilePackage.includes('"version": "1.3.14"') && app.includes('const APP_VERSION = "1.3.14"')],
