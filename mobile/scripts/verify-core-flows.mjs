...
const checks = [
  ...
  ["Android 交付版本為 v1.3.18／versionCode 41", appConfig.includes('"version": "1.3.18"') && appConfig.includes('"versionCode": 41') && mobilePackage.includes('"version": "1.3.18"') && app.includes('const APP_VERSION = "1.3.18"')],
