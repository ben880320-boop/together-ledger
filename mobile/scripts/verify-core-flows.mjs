...
const checks = [
  ...
  ["Android 交付版本為 v1.3.9／versionCode 32", appConfig.includes('"version": "1.3.9"') && appConfig.includes('"versionCode": 32') && mobilePackage.includes('"version": "1.3.9"') && app.includes('const APP_VERSION = "1.3.9"')],
