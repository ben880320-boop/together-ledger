...
const checks = [
  ...
  ["個人設定分區、版本資訊與穩定鍵盤避讓", app.includes('SettingsSection') && app.includes('目前版本 v{APP_VERSION}') && app.includes('KeyboardAvoidingView') && app.includes('Platform.OS === "ios" ? "padding" : undefined') && !app.includes('android: "height"') && appConfig.includes('"softwareKeyboardLayoutMode": "resize"')],
  ...
  ["Android 交付版本為 v1.3.11／versionCode 34", appConfig.includes('"version": "1.3.11"') && appConfig.includes('"versionCode": 34') && mobilePackage.includes('"version": "1.3.11"') && app.includes('const APP_VERSION = "1.3.11"')],
