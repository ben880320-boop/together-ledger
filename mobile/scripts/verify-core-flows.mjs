...
const checks = [
  ...
  ["Android 交付版本為 v1.3.10／versionCode 33", appConfig.includes('"version": "1.3.10"') && appConfig.includes('"versionCode": 33') && mobilePackage.includes('"version": "1.3.10"') && app.includes('const APP_VERSION = "1.3.10"')],
