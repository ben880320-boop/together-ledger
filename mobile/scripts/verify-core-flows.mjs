...
const checks = [
  ...
  ["Android 交付版本為 v1.3.12／versionCode 35", appConfig.includes('"version": "1.3.12"') && appConfig.includes('"versionCode": 35') && mobilePackage.includes('"version": "1.3.12"') && app.includes('const APP_VERSION = "1.3.12"')],
