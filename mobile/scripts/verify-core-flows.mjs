...
const checks = [
  ...
  ["Android 交付版本為 v1.3.6／versionCode 29", appConfig.includes('"version": "1.3.6"') && appConfig.includes('"versionCode": 29') && mobilePackage.includes('"version": "1.3.6"') && app.includes('const APP_VERSION = "1.3.6"')],
