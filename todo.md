...
- [ ] 重新稽核公開 Wiki 各頁的版本、功能與通知停用資訊是否與 v1.3.6 一致
- [ ] 將公開 Wiki 版本資訊同步至 v1.3.7／versionCode 30，說明圖示選擇器固定顯示無圖示選項與中文搜尋
- [x] 釐清 Android、Web 與 PWA 帳本設定未顯示新增圖示與「無圖示」選項的根因，修正共享資料、選擇器與發行產物一致性
- [x] 更新 v1.3.7 圖示選擇器回歸測試契約，覆蓋固定顯示「不使用圖示」及展開後中文搜尋的跨端行為
- [ ] 將已驗收的圖示選擇器可發現性修復發行為 v1.3.7 固定簽章 APK，提供可覆蓋安裝的 Android 更新
